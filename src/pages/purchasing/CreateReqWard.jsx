        ...
        const handleSubmit = async (e) => {
          ...
          try {
            fetch("http://localhost:4000/api/purchasingReq/create", {
              method: "POST",
              body: JSON.stringify(CreateReqWard),
              headers: {
              ...
              <CardContent>
                <form onSubmit={handleSubmit}>
                  <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                    ...
                    <div className="grid gap-2">
                      <Label htmlFor="purchasingDate">Ward Metrix</Label>
                      <Input
                        id="Wardmetrix"
                    ...
                    <div className="grid gap-2">
                      <Label htmlFor="warrantyPeriod">Room Number</Label>
                      <Input
                        id="roomNumber"
                    ...
                    <div className="grid gap-2">
                      ...
                      <Input
                        ...
                        required
                        value={genericName} // Value set programmatically
                      />
                    </div>
                ...
                <Select onValueChange={setrequestpriority} value={requestpriority}   >
                  <SelectTrigger>
